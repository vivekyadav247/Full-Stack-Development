...
// Intersection Types
// Intersection types allow you to combine multiple types into a single type. You can use the & operator to combine the different types. For example, you can define a type that combines a Person and an Employee as follows:
type Male = {
    speak: () => void;
}
